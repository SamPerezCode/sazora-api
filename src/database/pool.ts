...
- queueLimit con valor 0 no establece un límite artificial para las solicitudes en espera.- databasePool: será la instancia compartida por todos los módulos.
